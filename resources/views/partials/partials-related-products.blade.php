                                        ...
                                        @if($p->is_sale())
                                            <span>
                                                <p class="text-primary font-18 f-w-7 my-3">
                                                    <del class="mr-2">
                                                        <small>
                                                            <sup class="font-10">৳</sup>{{round($p->price,2)}}
                                                        </small>
                                                    </del>
                                                    <span class="text-success-gradient">
                                                        <sup class="font-10 text-success-gradient">৳</sup>{{round($p->discounted_price,2)}}
                                                    </span>
                                                </p>
                                            </span>
                                        @else
                                            <p class="text-primary font-18 f-w-7 my-3"><sup class="font-16">৳</sup>{{round($p->price,2)}}</p>
                                        @endif
                                    </div>
                                </div>
                            </div>
